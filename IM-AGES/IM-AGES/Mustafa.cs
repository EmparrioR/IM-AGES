...
namespace IM_AGES
{
    internal class Mustafa
    {
        ...
        private Bitmap PerformArithmeticOperation(Bitmap image1, Bitmap image2, Func<int, int, int> operation)
        {
            ...
            byte[] buffer1 = new byte[byteCount];//buffer1: İlk görüntünün piksel verilerini geçici olarak depolamak için kullanılır.
            ...
            for (int k = 0; k < byteCount; k += bytesPerPixel)// Bu döngü, byteCount değerine kadar her seferinde bytesPerPixel kadar artarak ilerler. Her iterasyon, bir pikselin tüm byte'larını işlemek içindir.
            {
